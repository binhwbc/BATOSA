...
<?php } elseif ($type=='vertical') {?>
  <div id="smoothmenu_<?php echo $code; ?>" class="ddsmoothmenu-v">
    <ul>
        <?php foreach ($menus as $menu1) { ?>
        <?php if (isset($menu1['children'])) { ?>
        <?php if($menu1['style']=='' || $menu1['style']=='dropdown'){ ?>
        <li class="level1">
          <a href="<?php echo $menu1['url']; ?>"  class="<?php echo $menu1['class']; ?>" ><?php echo $menu1['title']; ?> <b class="caret"></b>
...
<script>
ddsmoothmenu.init({
    mainmenuid: "smoothmenu_<?php echo $code; ?>", //Menu DIV id
...
<?php }else{ ?>
<div id="smoothmenu_h<?php echo $code; ?>" class="ddsmoothmenu-v">
    <ul>
        <?php foreach ($menus as $menu1) { ?>
        <?php if (isset($menu1['children'])) { ?>
        <?php if($menu1['style']=='' || $menu1['style']=='dropdown'){ ?>
