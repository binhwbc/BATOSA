...
class elFinderPluginWatermark {
    ...
    $force_transparent = $opts['force_transparent'];
    	...
    	return $this->watermarkPrint_imagick($src, $watermark, $dest_x, $dest_y, $quality, $transparency, $force_transparent, $watermarkImgInfo);
		} else {
			return $this->watermarkPrint_gd($src, $watermark, $dest_x, $dest_y, $quality, $transparency,$force_transparent,  $watermarkImgInfo, $srcImgInfo);
		}
	}
	
	private function watermarkPrint_imagick($src, $watermark, $dest_x, $dest_y, $quality, $transparency,$force_transparent, $watermarkImgInfo) {
	...
	private function watermarkPrint_gd($src, $watermark, $dest_x, $dest_y, $quality, $transparency, $force_transparent, $watermarkImgInfo, $srcImgInfo) {
