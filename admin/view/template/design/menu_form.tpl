            ...
            <div class="col-sm-10">
              <select name="type" id="input-type" class="form-control">
                ...
                <option value="vertical" <?php $types = ($type=='vertical')?'selected':''; echo $types; ?>><?php echo $input_vertical; ?></option>
              	<option value="list" <?php $types = ($type=='list')?'selected':''; echo $types; ?>><?php echo $input_list; ?></option>
              </select>

            </div>
          </div>

          <input type="hidden" name="oldpotition" value="<?php echo $position; ?>">
           <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <?php  
                ...
                <option value="<?php echo $x['position_id']; ?>" <?php $positions = ( $position == $x['position_id'])?'selected':''; echo $positions; ?>><?php echo $x['name']; ?></option>
                <?php } ?>
              </select>
