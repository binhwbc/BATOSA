            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $menu['type']; ?></td>
                  <td class="text-left"><?php echo $menu['position']; ?></td>
                  <td class="text-right">
                    <a href="<?php echo $menu['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                    <a href="<?php echo $menu['group']; ?>" data-toggle="tooltip" title="<?php echo $button_group; ?>" class="btn btn-primary"><i class="fa fa-bars"></i></a>
                  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
